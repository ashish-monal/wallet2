...
class DemoEventTicket {
  ...
  async updateClass(issuerId, classSuffix) {
    ...
    updatedClass["issuerName"] = "Carnation InfoTech 1";
  ...
  async createObject(issuerId, classSuffix, objectSuffix) {
    ...
    let newObject = {
      ...
      linksModuleData: {
        uris: [
          {
            uri: "https://developers.google.com/wallet/tickets/events/rest/v1/jwt/insert",
  ...
  async updateObject(issuerId, objectSuffix) {
    ...
    // let ticketHolderName = "Ashish Ranjan2";
    ...
    if (updatedObject["linksModuleData"] === undefined) {
      console.log("Line no 456", updatedObject["linksModuleData"]);
      updatedObject["linksModuleData"] = {
        uris: [newLink],
      };
    } else {
      console.log("Line no 460: ", updatedObject["seatInfo"]);
